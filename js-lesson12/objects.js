...
console.log(car["color"]) //? square bracket ile erisim    //? Square bracket yonteminin en buyuk avantaji key degerini degisken olarak kullanabilmemizdir.
...
console.log(this) //? Global scope da oldugumuzdan dolayi browser penceresinin en temel objesini yani "window" objesini gosterir
...
//? people objesindeki tum salary 'leri yazdirin: (Dongu kullanarak)
//! FOR - IN
//* for (key in object) {
//*    code block to be executed
//* }
// ;("strict") //? ---> Katı bir moda geçer, var gibi atama yapmasını engeller. (let / const gibi algılamayı sağlar)
for (let per in people) {
  console.log(per);
  console.log(people[per]);
  console.log(people[per].salary);
  console.log(people[per].name);
}
