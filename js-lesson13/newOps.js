...
//* functionun dondurdugu obje dogrudan destructing yapilabilir:
...
//* Bir fonksiyonun içerisine, bir objeyi geçirmek:
//*-------------------------------------------------------------

// const check = ({ a, b, c }) => { //? ---> yolda destruction yapmak
//   console.log(a, b, c)
// }

const check = (data) => {
  const { a, b, c } = data //? ---> icerde destruction yapmak
  console.log(a, b, c)
}
...
const [x, y, ...z] = autos // Destrc.   //? Rest işleminde array larda sıra önemli.
console.log(x, y, z)
...
const { age, ...fullName } = personel  //? Rest işleminde object lerde sıra önemli değil, çünkü key ile işlem yapılır.
